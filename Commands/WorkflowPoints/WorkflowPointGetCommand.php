...
/**
 * WorkflowPointGetCommand class
 * 
 * Command for getting workflow points
 * 
 ...
 * @version  	0.1.0-alpha
 */
class WorkflowPointGetCommand extends RepositoryCommand
{
    /**
	 * Create new WorkflowPointGetCommand
	 * 
